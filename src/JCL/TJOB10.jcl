//TJOB10 JOB (BENCHMARK),'ISPW TRAINING',
//         CLASS=A,MSGCLASS=H,MSGLEVEL=(1,1),TIME=(0,09)
//*
//TREXX10  EXEC PGM=IKJEFT01,DYNAMNBR=20,REGION=2048K
...
//SYSTSIN  DD *
  PROFILE MSGID
  ISPSTART  CMD(%TREXX10)
/*
//*==================================================
//* EXECUTE THE PROGRAM TPROG10 TO PRODUCE THE REPORT
//*==================================================
//PROCESS  EXEC PGM=TPROG10
