//PFHSXK01 JOB (BENCHMARK),'ISPW TRAINING',TYPRUN=HOLD,
//         CLASS=A,MSGCLASS=H,MSGLEVEL=(1,1),TIME=(0,09),NOTIFY=PFHSXK0
//*
//TREXX01  EXEC PGM=IKJEFT01,DYNAMNBR=20,REGION=2048K
//SYSPROC  DD DISP=SHR,DSN=SALESSUP.SXK1.DEV1.CLST
