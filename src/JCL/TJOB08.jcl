//TJOB08 JOB (BENCHMARK),'ISPW TRAINING',
//         CLASS=A,MSGCLASS=H,MSGLEVEL=(1,1),TIME=(0,09)
//*
//TREXX08  EXEC PGM=IKJEFT01,DYNAMNBR=20,REGION=2048K
...
//SYSTSIN  DD *
  PROFILE MSGID
  ISPSTART  CMD(%TREXX08)
/*
//*==================================================
//* EXECUTE THE PROGRAM TPROG08 TO PRODUCE THE REPORT
//*==================================================
//PROCESS  EXEC PGM=TPROG08
